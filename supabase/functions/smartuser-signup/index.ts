...
interface SmartUserSignupResponse {
  userId: string
  email: string
  token?: string
}

async function callSmartUserSignup(email: string, password: string): Promise<SmartUserSignupResponse> {
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const result = await callSmartUserSignup(email, password)
